...
var Popup = function (_React$Component) {
    ...
    Popup.prototype.render = function render() {
        return _react2["default"].createElement(
            _Modal2["default"],
            { animateAppear: true, onAnimationEnd: this.onAnimationEnd, animationType: this.props.animationType, wrapStyle: this.props.animationType === 'slide-up' ? _index2["default"].wrap : _index2["default"].wrapTop, visible: this.state.visible, onClose: this.props.maskClosable ? this.hide : undefined },
            this.props.children
        );
    };
