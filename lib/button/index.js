    ...
    Button.prototype.render = function render() {
        ...
        if (disabled) {
            return _react2["default"].createElement(
                _reactNative.View,
                (0, _extends3["default"])({}, this.props, { style: wrapperStyle }),
                newChild
            );
        }
        return _react2["default"].createElement(
            _reactNative.TouchableHighlight,
            (0, _extends3["default"])({ activeOpacity: 1, delayPressOut: 1 }, this.props, { underlayColor: activeStyle ? highlightStyles[type].backgroundColor : rawStyles[type].backgroundColor, style: wrapperStyle, onPress: function onPress(e) {
