    ...
    Brief.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                _reactNative.Text,
                { style: [styles.BriefText, style], numberOfLines: 1 },
                children
            )
        );
    };
    ...
    Item.prototype.render = function render() {
        ...
        if (Array.isArray(children)) {
                ...
                children.forEach(function (el, index) {
                    if (_react2["default"].isValidElement(el)) {
                        ...
                        tempContentDom.push(_react2["default"].createElement(
                            _reactNative.Text,
                            { style: [styles.Content], numberOfLines: 1, key: index + '-children' },
                            el
                        ));
                    }
                });
            ...
            if (_react2["default"].isValidElement(children)) {
                ...
                contentDom = _react2["default"].createElement(
                    ...
                    _react2["default"].createElement(
                        _reactNative.Text,
                        { style: [styles.Content], numberOfLines: 1 },
                        children
                    )
                );
            }
        ...
        if (extra) {
            extraDom = _react2["default"].createElement(
                ...
                _react2["default"].createElement(
                    _reactNative.Text,
                    { style: [styles.Extra], numberOfLines: 1 },
                    extra
                )
            );
                        ...
                        extraChildren.forEach(function (el, index) {
                            if (typeof el === 'string') {
                                tempExtraDom.push(_react2["default"].createElement(
                                    _reactNative.Text,
                                    { numberOfLines: 1, style: [styles.Extra], key: index + '-children' },
                                    el
                                ));
                            } else {
        ...
        var itemView = _react2["default"].createElement(
            _reactNative.View,
            (0, _extends3["default"])({}, this.props, { style: [styles.Item, line > 1 && { height: itemHeight }, style] }),
            ...
            _react2["default"].createElement(
                _reactNative.View,
                { style: [styles.Line, multipleLine && styles.multipleLine.Line] },
                contentDom,
                extraDom,
        ...
        return _react2["default"].createElement(
            ...
            { activeOpacity: 1, underlayColor: styles.underlayColor, onPress: onClick, onPressIn: onPressIn, onPressOut: onPressOut },
            itemView
        );
    };
