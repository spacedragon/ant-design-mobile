...
var ImagePickerExample = function (_React$Component) {
    ...
    ImagePickerExample.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(_antdMobile.ImagePicker, { onChange: function onChange(files) {
                    _this2.setState({
                        files: files
                    });
                }, files: this.state.files }),
            _react2["default"].createElement(_antdMobile.WhiteSpace, null),
            _react2["default"].createElement(_antdMobile.ImagePicker, { onChange: function onChange(files2) {
                    _this2.setState({
                        files2: files2
                    });
