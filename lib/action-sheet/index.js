...
var ActionSheetAndroid = function (_React$Component) {
    ...
    ActionSheetAndroid.prototype.render = function render() {
        return _react2["default"].createElement(
            _Modal2["default"],
            { animationDuration: 200, animateAppear: true, onClose: this.onClose, visible: this.state.visible, onAnimationEnd: this.onAnimationEnd, style: _index2["default"].content, animationType: 'slide-up' },
            this.props.children
        );
    };
