...
var TextAreaItem = function (_React$Component) {
    ...
    TextAreaItem.prototype.render = function render() {
        ...
        ['rows', 'error', 'clear', 'count', 'autoHeight', 'last', 'onErrorClick', 'onChange', 'value', 'multiline', 'numberOfLines', 'maxLength', 'styles'].forEach(function (prop) {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(_reactNative.TextInput, (0, _extends3["default"])({ style: [styles.input, textareaStyle, { height: Math.max(45, this.state.height) }], onChange: function onChange(event) {
                    return _this2.onChange(event);
                }, value: this.state.value, multiline: rows > 1 || autoHeight, numberOfLines: rows, maxLength: maxLength, clearButtonMode: clear ? 'while-editing' : 'never', underlineColorAndroid: 'transparent' }, restProps)),
