...
var CheckboxItem = function (_React$Component) {
    ...
    CheckboxItem.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ListItem,
            { style: style, onClick: disabled ? undefined : this.handleClick, line: line, extra: extra, thumb: _react2["default"].createElement(_Checkbox2["default"], { ref: refCheckbox, style: [styles.checkboxItemCheckbox, checkboxStyle], defaultChecked: defaultChecked, checked: checked, onChange: onChange, disabled: disabled }) },
            children
        );
    };
