    ...
    Grid.prototype.render = function render() {
        ...
        var renderItem = this.props.renderItem || function (dataItem) {
            return _react2["default"].createElement(
                _flex2["default"],
                { direction: 'column', justify: 'center', style: { flex: 1 } },
                _react2["default"].createElement(_reactNative.Image, { source: { uri: dataItem.icon }, style: styles.icon }),
        ...
        for (var i = 0; i < rowCount; i++) {
            ...
            rowsArr.push(_react2["default"].createElement(
                _flex2["default"],
                { key: i, style: [styles.grayBorderBox, {
