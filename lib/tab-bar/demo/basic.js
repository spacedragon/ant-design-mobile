...
var BasicTabBarExample = function (_React$Component) {
    ...
    BasicTabBarExample.prototype.render = function render() {
        ...
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(
                _antdMobile.TabBar.Item,
                { icon: require('./koubei.png'), selectedIcon: require('./koubei_sel.png'), title: '\u53E3\u7891', badge: this.state.notifCount > 0 ? this.state.notifCount : undefined, selected: this.state.selectedTab === 'redTab', onPress: function onPress() {
                        _this2.setState({
                            selectedTab: 'redTab',
