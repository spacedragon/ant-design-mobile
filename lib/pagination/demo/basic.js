...
var BasicPaginationExample = function (_React$Component) {
    ...
    BasicPaginationExample.prototype.render = function render() {
        return _react2["default"].createElement(
            ...
            _react2["default"].createElement(_antdMobile.Pagination, { total: 5, current: 1, prevText: '\u4E0A\u4E00\u6B65', nextText: '\u4E0B\u4E00\u6B65' }),
            _react2["default"].createElement(_antdMobile.WhiteSpace, { size: 'lg' }),
            _react2["default"].createElement(_antdMobile.Pagination, { simple: true, total: 5, current: 1, prevText: '\u4E0A\u4E00\u6B65', nextText: '\u4E0B\u4E00\u6B65' }),
            _react2["default"].createElement(_antdMobile.WhiteSpace, { size: 'lg' }),
